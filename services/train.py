...
def main():
    ...
    Train(args['network'], args['backbone'], args['epoch'], args['verbose'], args['batch_size'],
          ...
          args['score'], args['test'], args['augment'], args['threshold'],
          args['img_size']).train_model()
...
class Train:
    ...
    def train_model(self):
        ...
        Prepare_Dataset(PATCH_SIZE=self.IMG_SIZE).save_model(model, path=weight_path)
